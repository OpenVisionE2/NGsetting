...
<screen name="NGsettingE2" position="center,center" size="875,550" title="Main Menu" backgroundColor="#ff000000" flags="wfNoBorder" >
	...
	<!-- Text Maintain -->	
	<widget name="text" position="10,52" size="243,440" font="Regular;25" halign="left" foregroundColor="#808080" backgroundColor="#10202020" transparent="1" zPosition="1" />
	
	<!-- Clock -->
	<widget source="global.CurrentTime" render="Label" position="690,10" size="230,30" font="Regular;24"  zPosition="2" foregroundColor="#404040" backgroundColor="#202020" halign="center" transparent="1">
	...
	<widget position="270,440" size="610,31" name="dataDow"     font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" transparent="1" zPosition="3" />	
	<!--widget position="290,440" size="410,31" name="data"     font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" transparent="1" zPosition="3" /-->	

	<!-- Lcn Green Button -->	
	<widget  position="25,350" size="30,30"  name="Green" pixmap="~/Panel/greenpanel.png" zPosition="2" alphatest="blend" />
	<widget  position="60,349" size="200,24" name="Key_Lcn" font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" zPosition="1" transparent="1" />		
	...
	<widget  position="60,384" size="200,24" name="Key_Personal" font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" zPosition="1" transparent="1" />		
		
	<!-- AutoUpdate Blue Button -->		
	<widget  position="25,420" size="30,30"  name="Blue" pixmap="~/Panel/bluepanel.png" zPosition="2" alphatest="blend" />	
	<widget  name="autotimer" position="60,419" size="200,30"  font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" transparent="1" zPosition="3" />

	<!-- Exit Button -->
	<ePixmap position="25,455" size="30,30" pixmap="~/Panel/redpanel.png" zPosition="2" alphatest="blend" />	
	<widget  position="60,454" size="200,24" name="Key_Red" font="Regular;20" halign="left" foregroundColor="#808080" backgroundColor="#101010" zPosition="1" transparent="1" />
</screen>"""
